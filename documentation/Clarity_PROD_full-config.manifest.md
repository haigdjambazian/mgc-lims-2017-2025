# Generated from https://bravoprodapp.genome.mcgill.ca/ at Tue Jun 11 17:41:27 GMT 2019
...
* 10x Genomics Single Cell RNA v2
* ATAC-Seq Library
* Add Multiple Reagents
* Adenylate ends & Ligate Adapters (TruSeq DNA) 5.0
* Adenylate ends & Ligate Adapters (TruSeq RNA) 5.0
* Aggregate QC (DNA) 5.0
* Aggregate QC (Library Validation) 5.0
* Aggregate QC (RNA) 5.0
* Array Scanning and Analysis
* Axiom Analysis
* Axiom Analysis QC
* Axiom Scanning QC
* Bcl Conversion & Demultiplexing (HiSeq 3000/4000) 1.0
* Bioanalyzer QC (DNA) 5.0
* Bioanalyzer QC (RNA) 5.0
* CaliperGX QC 5.0
* CaliperGX QC 5.0 McGill 1.0
* Capture
* Centrifugation,Drying and Resuspension McGill 1.1
* ChIP-Seq
* ChIPmentation
* Choose Next Step (HiSeq X) 1.0 Validation
* Clean-up of Tagmented DNA (Nextera DNA) 5.0
* Cluster Generation (HiSeq 3000/4000) 1.0
* Cluster Generation (HiSeq X) 1.0
* Cluster Generation (HiSeq X) 1.0 McGill 1.0
* Cluster Generation (NovaSeq) 1.0 McGill 1.0
* Create Strip Tube (HiSeq X) 1.0
* Create Strip Tube (NovaSeq) 1.0 McGill 1.0
* DNA Amplification McGill 1.1
* DNA Extraction
* DNA Gel QC McGill 1.0
* DNA Samples QC
* Denaturation and Hybridization McGill 1.0
* EMC Aggregate QC (DNA) 5.0
* Enrich DNA fragments (TruSeq DNA) 5.0
* Enrich DNA fragments (TruSeq RNA) 5.0
* Extract DNA from Leaf
* Fragment & Label cDNA & Make Cocktails
* Fragment DNA (TruSeq DNA) 5.0
* Fragmentation  (Affy) McGill 1.0
* GeneTitan Reagent tray Preparation McGill 1.0
* Generic Library
* HaloPlex
* Hi-C Library Prep.
* Hybridization Preparation McGill 1.0
* Hybridization Sample QC McGill 1.0
* Hybridize Samples on Arrays (Affy) 1.0
* Illumina Generic Analysis
* Illumina Sequencing (HiSeq 3000/4000) 1.0
* Illumina Sequencing (HiSeq X) 1.0
* Illumina Sequencing (HiSeq X) 1.0 McGill 1.0
* Illumina Sequencing (HiSeq X) 1.0 McGill 1.1
* Illumina Sequencing (NovaSeq) 1.0 McGill 1.0
* Image Leaf
* Innoculate Leaf
* KAPA Hyper Plus
* Library Batch
* Library Normalization (HiSeq 3000/4000) 1.0
* Library Normalization (HiSeq X) 1.0
* Library Normalization (HiSeq X) 1.0 McGill 1.4
* Library Normalization (NovaSeq) 1.0 McGill 1.4
* Library Normalization for Pooling
* Library Pool
* Library Pooling (HiSeq 3000/4000) 1.0
* Library Pooling (HiSeq X) 1.0
* Library Pooling (NovaSeq) 1.0 McGill 1.0
* Live Cell Imaging QC
* Lucigen AmpFREE Low DNA 1.0
* Lysis and Sonication
* MCC Kapa
* MCC Lucigen
* MaGiC Samples Reception
* NanoDrop QC (DNA) 5.0
* NanoDrop QC (RNA) 5.0
* PCR Amplification (Nextera DNA) 5.0
* PCR Clean-up (Nextera DNA) 5.0
* PCR-enriched
* PCR-free
* PicoGreen QC (DNA) 5.0
* PicoGreen QC (RNA) 5.0
* Plate Creation
* Pool Samples
* Process Summary Report 5.0
* QC Leaf DNA
* Qubit QC (DNA) 5.0
* Qubit QC (RNA) 5.0
* RNASeq
* Repair Ends (TruSeq DNA) 5.0
* Repair Ends (TruSeq RNA) 5.0
* Sample History Report 5.0
* Sample Normalization
* Sample Normalization Extra Plate
* Sample Normalization Generic
* Sample Normalization Manual
* Sample Normalization Robot
* Sample Reception
* Sample Reception EMC
* System Add Indexes
* System Add Reagent Lots
* System Routing Carrier Samples
* System Routing Samples
* Tagment DNA (Nextera DNA) 5.0
* Tapestation QC (DNA) 5.0
* Tapestation QC (RNA) 5.0
* Tecan SPARK PicoGreen QC (DNA)
* Tecan SPARK PicoGreen QC (DNA) McGill 1.0
* Transcript Synthesis & Labeling
* WGBS
* WGBS KAPA Capture 1.0
* WGBS Kapa
* WGBS Lucigen Capture 1.0
* WGBS Lucigen TruSeqHT
* WGBS Lucigen TruSeqHT Capture 1.0
* Washing/Staining (Affy) 1.0
* mRNA Purification, Fragmentation & cDNA synthesis (TruSeq RNA) 5.0
* qPCR QC 5.0
...
* Affymetrix AGCC Validation
* Affymetrix Axiom Genotyping McGill 1.0
* Affymetrix Microarray 1.0
* CarrierTube_to_Plate
* ChIP-Seq Protocol
* Clarity System Management
* DNA Extraction
* DNA Initial QC 5.0
* DNA Initial QC EMC
* DNA Initial QC McGill
* Extraction
* Generic Prep
* HaloPlex McGill 1.0
* HaloPlex_QC_Plate
* Hi-C Library Prep.
* HiSeq 3000/4000 Validation
* HiSeq X 1.0 Validation Protocol
* Illumina SBS (HiSeq 3000/4000) 1.0
* Illumina SBS (HiSeq X) 1.0
* Illumina SBS (NovaSeq) McGill 1.0
* KAPA Hyper Plus
* Leaf Mould DNA Processing
* Library Batch
* Library Validation QC 5.0
* Library Validation QC McGill 1.0
* Lucigen AmpFree Low DNA
* MCC Kapa Prep
* MCC Lucigen Prep
* MaGiC Sample Reception
* Nextera DNA Library Prep 5.0
* PCR-enriched
* PCR-free
* Pool and Capture
* Pooling Protocol
...
* Sample Reception
* Sample Reception EMC
* TruSeq DNA PCR-Free Library Prep 5.0
* TruSeq Nano DNA Library Prep 5.0
* TruSeq RNA Library Prep 5.0
* WGBS KAPA Library
* WGBS KAPA Library Capture 1.0
* WGBS Lucigen Library
* WGBS Lucigen Library Capture 1.0
* WGBS Lucigen TruSeqHT Library
* WGBS Lucigen TruSeqHT Library Capture 1.0

# Manifest for Workflows
* Workflows=\
* 10XLinkedReads_LibQC
* 10xLinkedReads_Illumina_X_lib
* 10xscCNV_Illumina_X_lib
* 10xscCNV_LibQC
* 10xscRNA_Novaseq_lib
* ATAC-Seq_Illumina_X_lib
* ATAC-Seq_Novaseq_lib
* Affymetrix AGCC Integration Validation
* Affymetrix Axiom Genotyping McGill 1.0
* Affymetrix Microarray 1.0
* Axiom Norm Genotyping WF
* Capture_LibQC
* ChIPSeq_libqc
* Clarity System Management
* DNA Initial QC McGill WF
* DNA QC only
* DNA_Initial_QC_McGill_Carrier_WF
* HaloPlex_HS
* HaloPlex_LibQC
* Hi-C_Illumina_X_lib
* Hi-C_Novaseq_lib
* HiSeq 3000/4000 Validation
* HiSeq X 1.0 Validation
* HiSeqX
* KAPA_Illumina_X
* KAPA_Illumina_X_lib
* Leaf Mould
* LibQC
* Lucigen_Illumina_X
* Lucigen_Illumina_X_lib
* MCC_Kapa_Novaseq_lib
* MCC_Lucigen_Novaseq_lib
* MCC_WF_20190228
* MaGiC Sample Reception
* NovaSeq
* PCR-enriched_libqc
...
* Training 002
* Training QC
* TruSeq DNA PCR-Free for HiSeq X 1.0
* TruSeq Nano DNA for HiSeq X 1.0
* WGBS JSON NormM Lucigen Lib
* WGBS_KAPA_Capture_NovaSeq_lib
* WGBS_Kapa_Illumina_X_lib
* WGBS_Lucigen_Capture_NovaSeq_lib
* WGBS_Lucigen_Illumina_X_lib
* WGBS_Lucigen_TruSeqHT_Capture_NovaSeq_lib
* WGBS_Lucigen_TruSeqHT_Illumina_X_lib
* WGBS_Lucigen_libqc
* WGS_Lucigen_libqc
