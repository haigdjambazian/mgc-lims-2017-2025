...
@author: Alexander Mazur, alexander.mazur@gmail.com
    ...
    updated July 23, 2018:
        - added "IlluminaProtocol" option
        - added config file - "protocols.cfg"
...
parser.add_argument('-IlluminaProtocol',default='HiSeqX', help='<HiSeqX|NovaSeq>')
...
def main():
    ...
    if (stepURI_v2) :
        LibPooling,LibNorm,ClusterGen=read_config_file(script_dir+"/protocols.cfg")
        ...
        get_rb_parentProcess_UDF(parentProcessLUIDs,ClusterGen,"Start Date")
