...
sStripTubeHeader="Lane,Run McGill,Comments,Library Name,Country,Multiplex Key(s),Plate Barcode,Wells,Library Size,Conc.,Conc. Unit (nM or ng/µl),Volume (uL),Loading Conc. pM,PhiX,# OF LANES\n"
