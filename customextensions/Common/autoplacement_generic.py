...
def get_all_well_position_from_artifacts(sXML):    
    ...
    for artifact in pDOM.getElementsByTagName("art:artifact"):
        ...
        sampleID_Position[artContainer+"_"+str(get_phisical_position(artLocation))]=artName +"xxx"+containerName
        print(artContainer+"_"+str(get_phisical_position(artLocation))+"\t"+artName +"xxx"+containerName)
